...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMB] = LAYOUT( \
    _______,    _______, KC_Q,    KC_W,    KC_E,    KC_1,    KC_2,    KC_F1,   KC_F2,      KC_F3,     KC_F4,    KC_F5,   KC_F6,   _______, \
    ...
    _______,    _______, _______, _______, _______, KC_SPC,  KC_0,    _______, _______,    KC_LEFT,   KC_DOWN,  KC_RGHT, KC_RGUI, TO(BASE) \
  )
